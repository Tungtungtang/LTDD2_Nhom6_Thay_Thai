...
public class DatabaseFood extends SQLiteOpenHelper {
    ...
    public void getFood(ArrayList<Food> monHocs) {
        ...
        Cursor cursor = db.query(TB_FOOD,
                new String[]{FOOD_NAME, FOOD_INTRODUCE, FOOD_PRICE}, null, null,
                null, null, null);
        if (cursor.moveToFirst()) {
            do {
                ...
                Monhoc.setPrice(cursor.getString(cursor.getColumnIndex(FOOD_PRICE)));
    ...
    public boolean deleteFood(String id) {
        ...
        if (cursor.moveToFirst()) {
            Account.setTitle(cursor.getString(cursor.getColumnIndex(FOOD_NAME)));
            db.delete(TB_FOOD, FOOD_NAME + "=?",
                    new String[]{
                            String.valueOf(Account.getTitle())
                    });
            cursor.close();
            result = true;
        }
    ...
    public int updateFood(Food food) {
        ...
        return db.update(TB_FOOD, args, FOOD_NAME + " = ?",
                new String[]
                        {
                                String.valueOf(food.getTitle())
                        });
    }
}
